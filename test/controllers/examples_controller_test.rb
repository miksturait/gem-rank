...
class ExamplesControllerTest < ActionController::TestCase
  ...
  test "should create example" do
    assert_difference('Example.count') do
      post :create, example: { description: @example.description, rank: @example.rank, user_id: @example.user_id, votes: @example.votes }
    end
  ...
  test "should update example" do
    patch :update, id: @example, example: { description: @example.description, rank: @example.rank, user_id: @example.user_id, votes: @example.votes }
    assert_redirected_to example_path(assigns(:example))
  end
